...
Created the `script.sh` file through vibe coding (wasted few hours) to help with installation and automation of Kali VM setup. Using an old version of Kali on new projects with updates messes everything up. This should help. 
